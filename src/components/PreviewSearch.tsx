        ...
        <div className="rounded-xl overflow-hidden shadow-lg border border-gray-100 bg-transparent">
          <AuroraBackground className="min-h-0 w-full" showRadialGradient={false}>
            ...
            <div className="text-center pt-8 pb-6 sm:pt-10 sm:pb-8 w-full">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-3 sm:mb-4">Meet Our Top-Rated Property Content Experts</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto px-4">
                Trusted by real estate professionals nationwide — vetted creators ready to elevate your listings
              </p>
            </div>
