...
const TextAlongPath = () => {
  ...
  // Define a rounded rectangle path that completely surrounds the content
  const rectPath = "M 30,30 L 470,30 A 20,20 0 0,1 490,50 L 490,250 A 20,20 0 0,1 470,270 L 30,270 A 20,20 0 0,1 10,250 L 10,50 A 20,20 0 0,1 30,30";
  ...
  return <div className="w-full relative">
      <AuroraBackground showRadialGradient={false} className="w-full py-[2px]">
        <motion.section ref={sectionRef} className={cn(
          ...
          "px-4 sm:px-6",
          // Padding to accommodate the border text
          "py-[32px] sm:py-[48px]", 
          "my-[16px] sm:my-[24px]",
