...
const TextAlongPath = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setOffset((prev) => (prev - 0.1 + 100) % 100);
    }, 20);
  ...
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none">
      ...
      >
        ...
        {/* Top horizontal text, positioned above the title */}
        <path
          id="topPath"
          d="M 8,15 L 92,15"
          fill="none"
        ...
        <text className="text-xs">
          <textPath
            ...
            style={{ fontSize: '0.8rem', letterSpacing: '0.1em' }}
          >
            VISIONARIES OVER VENDORS • VISIONARIES OVER VENDORS • VISIONARIES OVER VENDORS •
          </textPath>
        </text>
        
        {/* Bottom horizontal text, positioned below the CTA */}
        <path
          id="bottomPath"
          d="M 8,85 L 92,85"
          fill="none"
  ...
  return <div className="w-full relative">
      <AuroraBackground showRadialGradient={false} className="w-full py-[2px]">
        <motion.section ref={sectionRef} className={cn(
          ...
          "px-4 sm:px-6",
          // Increased padding to make room for the text border
          "py-[40px] sm:py-[60px]",
          "my-[16px] sm:my-[24px]",
          ...
          {/* Added z-index to ensure it's behind main content */}
          <TextAlongPath />
        ...
        className="flex gap-4 sm:gap-5 flex-col max-w-6xl mx-auto w-full px-[3px] z-20">
            ...
            <div className={cn("text-sm sm:text-base lg:text-lg", "leading-[1.5]", "tracking-wide", "text-gray-700", "text-center", "max-w-[550px]", "mx-auto", "px-2 sm:px-4", "[word-spacing:0.12em] sm:[word-spacing:0.16em]", "z-20",
          "mt-1 mb-0")}>
        ...
        "mt-5 sm:mt-6", "px-3 sm:px-4", "z-20")} initial={{
          opacity: 0,
          y: 20
        }} animate={isInView ? {
          opacity: 1,
